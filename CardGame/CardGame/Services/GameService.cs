...
namespace CardGame.Services
{
    public class GameService
    {
        ...
        public string PlayGame(int numberOfDecks, IMatchChecker matchChecker)
        {
            // need to add players
            ...
            foreach (var card in shuffledDecks)
            {
                ...
                {   
                    ...
                    if (matchChecker.IsMatch(lastPlayedCard, card)) 
                    {
            ...
            // this can be refactored out to be testable
